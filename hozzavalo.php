        ...
        switch($_GET["action"]) {
            case "add":
                if(!empty($_POST["quantity"])) {
                    $productByCode = $db_handle->runQuery("SELECT * FROM hozzaval WHERE code='" . $_GET["code"] . "'");
                    // Cart item Array
...
<body>
    ...
    <div class="container-fluid fixed-top px-0 wow fadeIn" data-wow-delay="0.1s">
        ...
        <nav class="navbar navbar-expand-lg navbar-light py-lg-0 px-lg-5 wow fadeIn" data-wow-delay="0.1s">
            <a href="index.html" class="navbar-brand ms-4 ms-lg-0">
                <img src="img/mango.jpg" class="fw-bold text-primary m-0" width="60px" height="40px" alt="logo"> </a>
    ...
    <div class="container-fluid page-header mb-3 wow fadeIn" data-wow-delay="0.1s">
        <div class="container">
            <h1 class="display-3 mb-3 animated slideInDown">Termékek</h1>
            <nav aria-label="breadcrumb animated slideInDown">
                <ol class="breadcrumb mb-0">
                    <li class="breadcrumb-item"><a class="text-body" href="index.html">Home</a></li>
                    <li class="breadcrumb-item text-dark active" aria-current="page">Termékek</li>
                </ol>
            </nav>
        </div>
    </div>
    ...
    <div class="container-fluid bg-light bg-icon">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td style="text-align:center;"><a
                                href="hozzavalo.php?action=remove&code=<?php echo $item["code"]; ?>"
                                class="btnRemoveAction"><img src="img/icon-delete.png" alt="Remove Item" /></a></td>
                    </tr>
                    <?php
        ...
        <!-- Product Start -->
        <div class="container">
            <h3 class="txt-heading">Termékek</h3>
            <!-- Search in items -->
            <input id="txtSearch" type="text" name="search" placeholder="Kereső">
            
            <?php
                $product_array = $db_handle->runQuery("SELECT * FROM hozzaval ORDER BY id ASC");
                if (!empty($product_array)) { 
                    foreach($product_array as $key=>$value){               
            ?>

            <div class="product-item col-sm-4 container" id="items">
                <form  method="post" action="hozzavalo.php?action=add&code=<?php echo $product_array[$key]["code"]; ?>">
                <div class="prduct ">
    ...
    <!-- Testimonial Start -->
    <div class="container-fluid bg-light bg-icon py-6 mb-5 spacing">
        <div class="container">
            <div class="section-header text-center mx-auto mb-5 wow fadeInUp" data-wow-delay="0.1s" style="max-width: 500px;">
                <h1 class="display-5 mb-3">Értékelések</h1>
                <p>Vásárlók visszajelzései, értékelései.</p>
                <a href="ertekeles.php" class="btn btn-lg btn-primary">+
            ...
            <div class="owl-carousel testimonial-carousel wow fadeInUp" data-wow-delay="0.1s">
                <div class="testimonial-item position-relative bg-white p-5 mt-4">
                    ...
                    <p class="mb-4">Fantasztikus megoldás, követhető receptek, friss termékek. Egyszerű elkészítés és
                        kreatív megvalósítás.</p>
                    <div class="d-flex align-items-center">
                        <img class="flex-shrink-0 rounded-circle" src="img/avatar01.png" alt="avatár">
                        <div class="ms-3">
                            <h5 class="mb-1">Névtelen</h5>
                            <span>Vásárló</span>
                        </div>
                    </div>
                </div>
                <div class="testimonial-item position-relative bg-white p-5 mt-4">
                    <i class="fa fa-quote-left fa-3x text-primary position-absolute top-0 start-0 mt-n4 ms-5"></i>
                    <p class="mb-4">Egyszerűen kifogásolhatatlan, remek leírások és végre egy helyen tudom az
                        alapanyagot és a kész menüt vásárolni.</p>
                    <div class="d-flex align-items-center">
                        <img class="flex-shrink-0 rounded-circle" src="img/avatar01.png" alt="avatár">
                        <div class="ms-3">
                            <h5 class="mb-1">Névtelen</h5>
                ...
                <div class="testimonial-item position-relative bg-white p-5 mt-4">
                    <i class="fa fa-quote-left fa-3x text-primary position-absolute top-0 start-0 mt-n4 ms-5"></i>
                    <p class="mb-4">Ajánlani tudom mindenkinek aki nem hagyományos étrenden él. Kreatív receptek és
                        egyszerű elkészíteni.</p>
                    <div class="d-flex align-items-center">
                        <img class="flex-shrink-0 rounded-circle" src="img/avatar01.png" alt="avatár">
                        <div class="ms-3">
                            <h5 class="mb-1">Névtelen</h5>
                ...
                <div class="testimonial-item position-relative bg-white p-5 mt-4">
                    <i class="fa fa-quote-left fa-3x text-primary position-absolute top-0 start-0 mt-n4 ms-5"></i>
                    <p class="mb-4">Kedvező árak és akinek nincs sok ideje a konyhában, akkor elegendő megrendelni és
                        már fogyasztható is.</p>
                    <div class="d-flex align-items-center">
                        <img class="flex-shrink-0 rounded-circle" src="img/avatar01.png" alt="avatár">
                        <div class="ms-3">
                            <h5 class="mb-1">Névtelen</h5>
    ...
    <!-- Back to Top -->
    <a href="hozzavalo.php" class="btn btn-lg btn-primary btn-lg-square rounded-circle back-to-top">
